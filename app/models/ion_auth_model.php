...
class Ion_auth_model extends CI_Model {
  ...
  peg_id = '" . $user->id . "' ";
    ...
    public function get_user_by_id($id = false) {
       ...
       d.jabatan_nama, e.unit_kerja_nama, f.satuan_kerja_nama,coalesce(c.satuan_kerja_id,f.satuan_kerja_id) as satuan_kerja_id
  ...
  inner join m_spg_unit_kerja e on e.unit_kerja_id = c.unit_kerja_id
 left join m_spg_satuan_kerja f on f.satuan_kerja_id = coalesce(c.satuan_kerja_id,e.satuan_kerja_id)  
WHERE a.id = ' . $id; 
        return $this->db->query($sql);
    }
