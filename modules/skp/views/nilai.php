  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" action="<?php echo base_url();?>skp/penilaian" method="post">
      ...
      <?php if($this->input->post('select_c_nik_pgw')) { ?>
		...
		<div class="col-sm-12">
			<div class="form-group pull-right">
				...
				<a target="_blank" href="<?php echo base_url('skp/cetak/print_penilaian/') . '/' . $pegawai_result->peg_nip_baru;?>"class="btn btn-success btn-lg"><i class="glyphicon glyphicon-print"></i> Cetak</a>
			</div>
		</div>
    <?php } else { ?>
      <i>Silahkan pilih pegawai terlebih dahulu</i>
